...
public class BottenItem extends FurrymodModElements.ModElement {
	@ObjectHolder("furrymod:botten")
	public static final Item block = null;

	public BottenItem(FurrymodModElements instance) {
		super(instance, 13);
	}
